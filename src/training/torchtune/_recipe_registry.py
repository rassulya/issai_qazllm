...
_ALL_RECIPES = [
    ...
    Recipe(
        name="full_finetune_distributed_loop_no_val",
        file_path="full_finetune_distributed_loop_no_val.py",
        configs=[
            Config(name="llama2/7B_full", file_path="llama2/7B_full.yaml"),
            Config(name="llama2/13B_full", file_path="llama2/13B_full.yaml"),
            Config(name="llama3/8B_full", file_path="llama3/8B_full.yaml"),
    ...
    Recipe(
        name="full_finetune_distributed_loop_no_val_gas",
        file_path="full_finetune_distributed_loop_no_val_gas.py",
        configs=[
            Config(name="llama2/7B_full", file_path="llama2/7B_full.yaml"),
            Config(name="llama2/13B_full", file_path="llama2/13B_full.yaml"),
            Config(name="llama3/8B_full", file_path="llama3/8B_full.yaml"),
