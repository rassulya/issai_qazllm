...
python tune.py run --nproc_per_node=8 --nnodes=6 --master_addr=<ip_address> --master_port=1234 --node_rank=1  full_finetune_distributed_loop_no_val --config config_train/70B_3.1_instruct_noval_loop.yaml